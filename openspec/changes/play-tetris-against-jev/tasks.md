...
- [ ] 3.2 Implement start, pause, resume, immediate seeded restart, round progression, and win/draw resolution; verify tests cover preserved state on resume, fresh sequence on restart, independent line clears, single top-out, and simultaneous top-out.
