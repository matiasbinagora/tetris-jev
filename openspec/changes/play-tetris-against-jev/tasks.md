...
- [ ] 2.1 Implement the 10 by 20 board with hidden spawn rows, seven standard tetrominoes, deterministic spawn positions, collision checks, and the documented Super Rotation System kick order; verify unit tests cover every piece orientation, wall/floor collisions, and blocked rotations.
